...
class precautionCell: UITableViewCell {
    ...
    func set(precautionZeroCellVCmodel: precautionZeroCellVCModel) {
        //let urlString = newsinfo.image
        //let url = URL(string: urlString)
        let urlString = precautionZeroCellVCmodel.image
        let url = URL(string: urlString)
        tableImageView.downloaded(from: url!)
        tableHeadTitleLabel.text = precautionZeroCellVCmodel.title
       // let test = String(text.filter { !" \n\t\r".contains($0) })
        tableTailTitleLabel.text = String(precautionZeroCellVCmodel.brief.filter { !"<h4></h4>&nbsp;&nbsp;".contains($0) })//symptomZeroCellVCmodel.brief
    }
    ...
    func setImageConstraints() {
        ...
        //tableImageView.heightAnchor.constraint(equalToConstant: 80).isActive = true
         ...
         tableImageView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -54).isActive = true
    ...
    func setHeadTitleLabelConstraints() {
       ...
       // tableHeadTitleLabel.heightAnchor.constraint(equalToConstant: 20).isActive = true
          tableHeadTitleLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -08).isActive = true
    }
    func setTailTitleLabelConstraint() {
        tableTailTitleLabel.translatesAutoresizingMaskIntoConstraints = false
        tableTailTitleLabel.topAnchor.constraint(equalTo: tableHeadTitleLabel.bottomAnchor, constant: 04).isActive = true
        ...
        tableTailTitleLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -08).isActive = true
    }
